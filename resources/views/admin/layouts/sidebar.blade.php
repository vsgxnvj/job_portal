  ...
  <div class="main-sidebar sidebar-style-2">
      <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
              <a href="{{ route('admin.dashboard') }}">MyApp</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
              <a href="{{ route('admin.dashboard') }}">MA</a>
          </div>
          <ul class="sidebar-menu">
              ...
              <li
                  ...
                  <a href="#" class="nav-link has-dropdown" data-bs-toggle="dropdown">
                      <i class="fas fa-columns"></i> <span>Attributes</span>
                  </a>
                  <ul class="dropdown-menu">
                      <li class="{{ setsidebarActive(['admin.industry-type.*']) }}">
                          <a class="nav-link" href="{{ route('admin.industry-type.index') }}">Industry Type</a>
                      </li>
                      <li class="{{ setsidebarActive(['admin.organization-type.*']) }}">
                          <a class="nav-link" href="{{ route('admin.organization-type.index') }}">Organization Type</a>
                      </li>
                      <li class="{{ setsidebarActive(['admin.languages.*']) }}">
                          <a class="nav-link" href="{{ route('admin.languages.index') }}">Languages</a>
                      </li>
                      <li class="{{ setsidebarActive(['admin.professions.*']) }}">
                          <a class="nav-link" href="{{ route('admin.professions.index') }}">Professions</a>
                      </li>
                      <li class="{{ setsidebarActive(['admin.skills.*']) }}">
              ...
              <li class="dropdown {{ setsidebarActive(['admin.countries.*', 'admin.states.*', 'admin.cities.*']) }}">
                  ...
                  <ul class="dropdown-menu">
                      ...
                      <li class="{{ setsidebarActive(['admin.states.*']) }}">
                          <a class="nav-link" href="{{ route('admin.states.index') }}">States</a>
                      </li>
                      <li class="{{ setsidebarActive(['admin.cities.*']) }}">
